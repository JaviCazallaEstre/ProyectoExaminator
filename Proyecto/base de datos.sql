...
CREATE TABLE IF NOT EXISTS `examinador`.`usuarios` (
  ...
  `apellidos` VARCHAR(45) CHARACTER SET 'latin1' NULL DEFAULT NULL,
  `contrasena` VARCHAR(20) CHARACTER SET 'latin1' NULL DEFAULT NULL,
  `fecha_nac` DATE NULL DEFAULT NULL,
  `foto` VARCHAR(300) CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci' NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `examinador`.`pregunta` (
  ...
  `recurso` VARCHAR(100) CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci' NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `examinador`.`registropendiente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `examinador`.`registropendiente` (
  `id` INT(11) NOT NULL,
  `hash` VARCHAR(45) CHARACTER SET 'utf8' NOT NULL,
